...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-800 shadow-inner pt-6 pb-4">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center border-t border-gray-200 dark:border-gray-700 pt-4">
          <div className="mb-4 md:mb-0">
            <h3 className="text-lg font-bold text-left text-purple-700 dark:text-purple-400">HostelMate</h3>
